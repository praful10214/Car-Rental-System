...
if($charge_type == "days"){
    ...
    $sql1 = "UPDATE rentedcars SET car_return_date='$car_return_date', no_of_days='$no_of_days', total_amount='$total_amount' WHERE id = '$id' ";
} else {
    $distance = $distance_or_days;
    $sql1 = "UPDATE rentedcars SET car_return_date='$car_return_date', distance='$distance', no_of_days='$duration', total_amount='$total_amount' WHERE id = '$id' ";
}

$result1 = $conn->query($sql1);

if ($result1){
     $sql2 = "UPDATE cars c, driver d, rentedcars rc SET c.car_availability=1, d.driver_availability='yes' 
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                ?>
                <h4> <strong>Total Fine:</strong> <label class="text-danger"> रू<?php echo $total_fine; ?>/- </label> for <?php echo $extra_days;?> extra days.</h4>
                <br>
                <?php } ?>
                <h4> <strong>Total Amount: </strong> रू<?php echo $total_amount; ?>/-     </h4>
                <br>
                <div style="float: none; margin: 0 auto; text-align: center;"> 
                <?php 
            echo "<button class='btn btn-primary btn-lg rounded-pill shadow-sm' onclick=epay_gateway($id,$total_amount)> <span class='fw-bold text-uppercase'>Pay now</span> </button>";
            ?></div>
            </div>

        </div>
        <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6>Warning! <strong>Do not reload this page</strong> or the above display will be lost. If you want a hardcopy of this page, please print it now.</h6><br><br>
        ...
        window.addEventListener('scroll', function() {
            ...
            if (footerPosition < windowHeight) {
                ...
                footer.querySelector('.social-icons').classList.add('show');
                        ...
                        function epay_gateway(data,tamnt){
                            val = 'esewa/paynow.php?pay_id='+data+"&ta="+tamnt;
