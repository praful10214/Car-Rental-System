...
<div class="login-container">
    ...
    <form action="" method="POST" id="loginForm">
        <div>
            ...
            <input type="text" id="client_username" name="client_username" placeholder="Enter username" required autofocus>
        ...
        <div>
            ...
            <div>
                <input type="password" id="client_password" name="client_password" placeholder="Enter password" required>
	...
	<div class="social-icons">
        ...
        <div class="create-account">
            <p>Don't have an account? <a href="clientsignup.php">Create one</a></p>
        </div>
    </form>
</div>
  ...
  var username = document.getElementById("client_username").value;
  var password = document.getElementById("client_password").value;
  
  // Here you can check if the username and password are correct.
  // For this example, let's say the correct username is "user" and password is "password".
  if (username === "user" && password === "password") {
    return true; // Correct credentials, proceed to login
  } else {
