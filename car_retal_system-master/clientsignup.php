...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1>Welcome to DajuBhai Rental</h1>
            <br>
    ...
    <div class="login-container">
     ...
     <form role="form" id="registrationform" action="client_registered_success.php" method="POST" onsubmit="return validateForm()">

                        <div>
                                <label for="client_name"><span class="text-danger" style="margin-right: 5px;">*</span> Full Name: </label>
                                <div>
                                    <input id="client_name" type="text" name="client_name" placeholder="Your Full Name" required="" autofocus="">
                            </div>
                        </div>
                        <div>
                        <label for="client_username"><span class="text-danger" style="margin-right: 5px;">*</span> Username: </label>
                                <div>
                                    <input id="client_username" type="text" name="client_username" placeholder="Your Username" required="">
                            </div>
                        </div>
    ...
    <div>
        <input id="client_email" type="email" name="client_email" placeholder="Email" required="">
...
<div>
    ...
    <div>
        <input id="client_phone" type="text" name="client_phone" placeholder="Phone" required="">
...
<div>
                                <label for="client_address"><span class="text-danger" style="margin-right: 5px;">*</span>Address: </label>
                                  <div>
                                    <input id="client_address" type="text" name="client_address" placeholder="Address" required=""></div>
                        </div>

<div>
    <label for="client_password"><span class="text-danger" style="margin-right: 5px;">*</span>Password: </label>
    <div>
        <input id="client_password" type="password" name="client_password" placeholder="Password" minlength='7' maxlength='15' required="">
		...
		<button onclick= "window.location.href='https:/'+'/github.com/';" aria-label="Log in with GitHub" class="icon">
            ...
            <p>Already have an account? <a href="clientlogin.php">Log In</a></p>
        </div>
...
//   } else {
//     passwordError.textContent = "Password doesn't match"; // Clear error message
//   }
// });
        $(document).ready(function () {
            $('#togglePassword').click(function () {
                var passwordField = $('#client_password');
